            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <x-auth-validation-errors class="mb-4" :errors="$errors" />
                    <form method="post" action="{{route('owner.products.update', ['product'=>$product->id])}}">
                        ...
                        <div class="m-2">
                            ...
                            <div class="p-2 w-full mx-auto">
                                <div class="relative">
                                    ...
                                    <textarea type="text" id="information" name="information" required rows="10" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{$product->information}}</textarea>
                                </div>
                            </div>
                            <div class="p-2 w-full mx-auto">
                                <div class="relative">
                            ...
                            <div class="p-2 w-full mx-auto">
                                <div class="relative">
                                    ...
                                    <div class="p-2 w-1/2 max-auto text-base outline-none text-gray-700 py-1 px-3 leading-8">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    ...
                                    <select name="shop_id" input type="number" id="shop_id" name="shop_id" value="{{old('sort_order')}}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    ...
                                    <select name="category" input type="number" id="category" value="{{old('sort_order')}}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        ...
                        <x-select-image :images="$images" currentId="{{$product->image3}}" currentImage="{{$product->imageThrid->filename ?? ''}}" name="image3" />
                        <x-select-image :images="$images" currentId="{{$product->image4}}" currentImage="{{$product->imageFourth->filename ?? ''}}" name="image4" />
                        <x-select-image :images="$images" name="image5" />
                        <div class="p-2 w-1/2 max-auto">
                            <div class="relative flex justify-around">
                    ...
                    <form id="delete_{{$product->id}}" method="post" action="{{route('owner.products.destroy', ['product'=>$product->id])}}">
                        ...
                        <a href="#" data-id="{{$product->id}}" onclick="deletePost(this)" class="text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg">Delete</a>
                        </div>
