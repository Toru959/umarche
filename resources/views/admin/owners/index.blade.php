                ...
                <div class="flex justify-end mb-4">
                    ...
                    <table class="table-auto w-full text-left whitespace-no-wrap">
                        ...
                        <tr>
                            ...
                            <th class="md:px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">detail</th>
                        ...
                        <tr>
                            ...
                            <td class="border-t-2 border-gray-200 md:px-4 py-3">{{$owner->created_at}}</td>
